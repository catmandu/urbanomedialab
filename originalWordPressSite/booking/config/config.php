...
$conf['settings']['admin.email'] = 'pablo@urbanomedialab.com';         // email address of admin user
...
$conf['settings']['script.url'] = 'http://urbanomedialab.com/booking/Web';   	// public URL to the Web directory of this instance. this is the URL that appears when you are logging in. leave http: or https: off to auto-detect
...
$conf['settings']['database']['user'] = 'pablo';        // database user with permission to the booked database
$conf['settings']['database']['password'] = 'password';
$conf['settings']['database']['hostspec'] = 'urbanomedialabcom.ipagemysql.com';        // ip, dns or named pipe
 ...
 */
$conf['settings']['install.password'] = 'starrago';
/**
 * Pages
 */
