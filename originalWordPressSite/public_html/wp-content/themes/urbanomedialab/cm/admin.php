...
$publicPath = explode('wp-content', $path)[0];

require_once($publicPath.'wp-load.php');

if(is_user_logged_in()){

    $filePath = str_replace('cm', '', $path).'js\languages.json';
    ...
    $publicUrl = explode('wp-content', $url)[0];

    header('Location: '.$publicUrl.'wp-login.php');
}
