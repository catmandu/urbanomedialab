		...
		if(is_array($links)){ 
			foreach($links as $current_link){
				if($current_link['url'] != ''){
					...
					if($current_link['icon'] != '') echo '<span class="social-icon">'.cpotheme_icon($current_link['icon']).'</span>';
	...
	function cpotheme_menu($options = null){
		...
		if($page_header != 'minimal' && $page_header != 'none'){
			if(has_nav_menu('main_menu')){
				...
				wp_nav_menu(array('menu_id' => 'menu-main', 'menu_class' => 'menu-main', 'theme_location' => 'main_menu', 'depth' => '4', 'container' => false ));
			}
		}
	}
}
	...
	function cpotheme_mobile_menu($options = null){
		...
		if($page_header != 'minimal' && $page_header != 'none'){
			...
			if(has_nav_menu('mobile_menu')){
				...
				wp_nav_menu(array('menu_id' => 'menu-mobile', 'menu_class' => 'menu-mobile', 'theme_location' => 'mobile_menu', 'depth' => '4', 'container' => false ));
			}elseif(has_nav_menu('main_menu')){
				echo '<div id="menu-mobile-close" class="menu-mobile-close menu-mobile-toggle"></div>';
				wp_nav_menu(array('menu_id' => 'menu-mobile', 'menu_class' => 'menu-mobile', 'theme_location' => 'main_menu', 'depth' => '4', 'container' => false ));
			}
		}
	}
}
